...
def put_static_route(odlip, dev_name, prefix, dest) :
    ...
    resp = requests.put(url, data=request_body, headers=req_hdrs, auth=(odl_user, odl_pass))
    print (resp)

if __name__ == '__main__':
     put_static_route('127.0.0.1', 'kcy', '111.0.0.0/24', '1.1.1.1')